...
// })
const { register, login, updateUser,upload,getallgroups,getsingleGroup,getallgroupsbyrequest,authenticateGroup}  = require('../controllers/authGroupController') 
...
router.route('/authenticategroup').get(authenticateGroup)

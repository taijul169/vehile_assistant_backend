...
// })
const { register,assignGroupToRequest,getAllrequestsBystatusGROUPID,getAllrequestsBystatus,getAllRequest,getallassignedRequestbyGROUPID,getsinglerquest}  = require('../controllers/authRequestController') 
